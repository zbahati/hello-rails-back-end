...
This repo consumes API data from [Hello Rails Back-End](https://github.com/zbahati/hello-rails-back-end) project.
...
> cd my-folder
> git clone https://github.com/zbahati/hello-react-front-end
...
- GitHub: [@Bahati](https://github.com/zbahati)
- Twitter: [@bahati](https://twitter.com/zbahati)
- LinkedIn: [zirimwabagabo bahati](https://www.linkedin.com/in/zirimwabagabo-bahati/)
